Pod::Spec.new do |spec|
    ...
    spec.user_target_xcconfig = { 
      'LIBRARY_SEARCH_PATHS' => '$(PODS_ROOT)/libbson/libmongoc/libbson.framework/Frameworks',
      'SWIFT_INCLUDE_PATHS' => '$(PODS_ROOT)/libbson/libmongoc/libbson.framework/Modules'
    }
