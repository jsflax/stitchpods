Pod::Spec.new do |spec|
    ...
    spec.pod_target_xcconfig = { 
      'LIBRARY_SEARCH_PATHS' => '$(PODS_TARGET_SRCROOT)/Frameworks/libbson.framework/Frameworks',
      'SWIFT_INCLUDE_PATHS' => '$(PODS_TARGET_SRCROOT)/Frameworks/libbson.framework/Modules'
    }

    spec.user_target_xcconfig = { 
      'LIBRARY_SEARCH_PATHS' => '$(PODS_ROOT)/libbson/libmongoc/Frameworks/libbson.framework/Frameworks',
